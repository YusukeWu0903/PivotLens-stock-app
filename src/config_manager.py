...
STRATEGY_CONFIG = {
    ...
    "短多 (日K 5MA + 20MA)": {
        ...
        "short_ma": 5,
        "long_ma": 20,
        "n_days": 10,  # 👈 原 5 天改為 10 天
        "desc": "適合短線轉折：抓取近 10 日內 5MA 金叉 20MA，且股價衝高回測月線守穩之標的。",
    },
    "中多 (日K 20MA + 60MA)": {
        "timeframe": "D",
        "short_ma": 20,
        "long_ma": 60,
        "n_days": 20,  # 👈 原 10 天改為 20 天
        "desc": "適合波段佈局：抓取近 20 日內 20MA 金叉 60MA，且完成波段整理回測季線之標的。",
    },
    "長多 (周K 13MA + 52MA)": {
        "timeframe": "W",
        "short_ma": 13,
        "long_ma": 52,
        "n_days": 20,  # 保持近 20 個日曆天
        "desc": "適合大趨勢保護：抓取近 20 日內周線 13MA 金叉 52MA 之長線發動股。",
    },
    # 📉 空方策略同步對應
    "短空 (日K 5MA + 20MA)": {
        "timeframe": "D",
        ...
        "long_ma": 20,
        "n_days": 10,
        "desc": "適合短線避險/做空：抓取近 10 日內 5MA 死叉 20MA，且反彈至月線受阻之標的。",
    },
    "中空 (日K 20MA + 60MA)": {
        "timeframe": "D",
        "short_ma": 20,
        "long_ma": 60,
        "n_days": 20,
        "desc": "適合波段避險/做空：抓取近 20 日內 20MA 死叉 60MA，且反彈至季線受阻之標的。",
    },
    "長空 (周K 13MA + 52MA)": {
        "timeframe": "W",
        "short_ma": 13,
        "long_ma": 52,
        "n_days": 20,
        "desc": "適合大趨勢避險：抓取近 20 日內周線 13MA 死叉 52MA 之長線空頭確認股。",
    },
}
